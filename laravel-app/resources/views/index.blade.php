...
<body class="bg-cream text-ink antialiased">
  ...
  <div id="cookiePopup" class="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:w-[420px] z-[9998]">
    ...
    <nav class="max-w-7xl mx-auto px-4 lg:px-6 ">
      <div class="flex items-center justify-between h-16">
              ...
              <div class="bg-white border-t border-b border-black/10 shadow-soft">
                <div class="max-w-7xl mx-auto px-6 py-6 grid grid-cols-4 gap-6">
                  ...
                  <div class="bg-cream2 p-4 border border-black/10">
                    ...
                    <a href="{{ route('actualites') }}" class="inline-block mt-3 text-sm font-semibold text-rdcBlue hover:underline">
                      Voir les actus →
                    </a>
                  </div>
                </div>
        ...
        <div class="flex items-center gap-2">
          <a class=" hidden lg:block cursor-pointer hover:text-brand-2" href="#login" title="Login" aria-label="Login"
            data-tracking="nav">
      ...
      <div id="mobileMenu"
        ...
        <div class="pb-4 pt-2 space-y-2 text-sm">
          ...
          <a href="#login"
            class="lg:hidden inline-flex items-center justify-center gap-2 w-full px-3 py-2 bg-rdcGold text-dark text-xs font-bold uppercase tracking-wider hover:bg-rdcGold/60 transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 17" class="size-6">
              <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" clip-path="url(#a)">
                <path d="M8 10.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8M2 14c1.21-2.092 3.41-3.5 6-3.5s4.79 1.408 6 3.5"></path>
              </g>
  ...
  <section id="accueil" class="relative h-screen max-h-[19.4375rem] w-full overflow-hidden bg-ink md:max-h-[42rem]">
    <div class="absolute inset-0 h-full w-full">
      <iframe class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none"
        ...
        src="https://www.youtube.com/embed/ScmzI1WQEfq?start=0&autoplay=1&mute=1&controls=0&loop=1&playlist=ScmzI1WQEfq&modestbranding=1&playsinline=1"
        frameborder="0" allow="autoplay; encrypted-media" allowfullscreen title="Fond vidéo Défense RDC"></iframe>
    </div>

    <div
      class="relative z-10 flex h-full w-full items-center justify-center bg-gradient-to-b from-black/70 via-black/55 to-black/80 p-4">
  ...
  <section id="biographie" class="max-w-7xl mx-auto px-4 lg:px-6 py-16 grid lg:grid-cols-2 gap-8 items-center">
    <div class="aspect-square bg-white border border-black/10 shadow-soft relative overflow-hidden">
      ...
      <img src="{{ asset('assets/NTAMBWE_MPOSHI_CHARMANT_ELIEZER.jpg') }}" alt="Éliézer Ntambwe">
    ...
    <div class="mt-6 grid lg:grid-cols-3 gap-5">
      ...
      <article class="bg-white overflow-hidden border border-black/10 shadow-soft hover:-translate-y-1 transition">
        <div class="relative h-40 w-full overflow-hidden">
          <img src="{{ asset('assets/bcc_kin.jpg') }}" alt="ancient combattant" class="w-full h-full object-cover object-center">
      ...
      <div class="mt-8 flex flex-col gap-4">
        ...
        <div
          ...
          <div class="flex-1">
            <div class="flex flex-wrap items-center gap-2 mb-1">
              <span
                class="inline-block bg-black/5 text-black/70 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Note
                de service</span>
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div
          ...
          <div class="flex items-start justify-between mb-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 text-black/30 group-hover:text-rdcBlue transition-colors">
              <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
          ...
          <div class="flex items-start justify-between mb-4">
            <div
              class="inline-flex items-center px-2 py-1 bg-rdcGold/20 text-ink text-[10px] font-bold uppercase tracking-widest">
              Arrêté
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 text-black/30 group-hover:text-rdcBlue transition-colors">
  ...
  <section id="missions" class="bg-cream2 border-y border-black/10">
    <div class="max-w-7xl mx-auto px-4 lg:px-6 py-16 grid lg:grid-cols-2 gap-10 items-center">
      ...
      <div class="aspect-[4/3] bg-white shadow-soft border border-black/10 relative overflow-hidden">
        ...
        <img src="{{ asset('assets/ancien-combattant-2.jpg') }}" alt="soldat vétérans"
        ...
        <div class="grid grid-cols-2 gap-10 lg:hidden">
          ...
          <div>
            ...
            <ul class="space-y-2 text-[0.9rem] text-black/70 leading-relaxed">
              <li><a href="{{ route('actualites') }}" class="hover:text-rdcBlue">Actualités</a></li>
  ...
  <script>
    ...
    acceptCookies.addEventListener("click", () => { localStorage.setItem("cookieChoice", "accepted"); hideCookies(); });
    declineCookies.addEventListener("click", () => { localStorage.setItem("cookieChoice", "declined"); hideCookies(); });
    customizeCookies.addEventListener("click", () => { localStorage.setItem("cookieChoice", "custom"); hideCookies(); });
