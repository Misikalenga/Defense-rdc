            ...
            <div class="grid lg:grid-cols-2 gap-10">
                ...
                <div class="bg-white p-6 shadow-soft border border-black/10">
                    ...
                    <form class="space-y-4">
                        <input type="text" placeholder="Nom complet" class="w-full border border-black/20 p-3 focus:outline-none focus:border-rdcBlue">
                        <input type="email" placeholder="Adresse email" class="w-full border border-black/20 p-3 focus:outline-none focus:border-rdcBlue">
                        <input type="text" placeholder="Objet" class="w-full border border-black/20 p-3 focus:outline-none focus:border-rdcBlue">
                        <textarea placeholder="Votre message" rows="5" class="w-full border border-black/20 p-3 focus:outline-none focus:border-rdcBlue"></textarea>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 shadow-soft border border-black/10">
                        ...
                        <p class="text-black/70 mb-1">📍 {!! nl2br(e(setting('contact.address'))) !!}</p>
                        <p class="text-black/70">📞 {{ setting('contact.phone') }}</p>
                        <p class="text-black/70">✉️ {{ setting('contact.email') }}</p>
                    </div>
